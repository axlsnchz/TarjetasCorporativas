...
public class SQLConnector {
        ...
        try {
            ...
            if (dbUser == null || dbPass == null || dbName == null) {
                ...
                try (InputStream is = classLoader.getResourceAsStream("credentials.properties")) {
                    ...
                    // 1. Convertimos el InputStream en bytes para poder analizarlo sin consumirlos
                    byte[] fileBytes = readAllBytesFromStream(is);
    ...
    private static byte[] readAllBytesFromStream(InputStream is) throws java.io.IOException {
