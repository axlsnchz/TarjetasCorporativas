            ...
            <form>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group rounded-2 overflow-hidden border-0 border-bottom border-2" style="border-color: #3A494B !important;">
                        ...
                        <input type="email" class="form-control border-0 py-3 bg-figma-input text-white shadow-none" placeholder="nombre@fintechcorp.com" required style="font-size: 0.95rem;">
                    </div>
                </div>
                ...
                <!-- Botón Secundario de Contorno Cyan (Volver al Inicio) -->
                <a href="index.jsp" class="btn btn-outline-info rounded-pill w-100 py-3 fw-bold d-flex align-items-center justify-content-center gap-2 mt-3 text-figma-cyan"
