        ...
        <div class="card bg-figma-card rounded-4 p-4 mb-5 border font-jakarta" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
            ...
            <form class="row g-4">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="input-group rounded-2 overflow-hidden">
                        <span class="input-group-text border-0 text-secondary px-3" style="background-color: #1E2024;"><i class="bi bi-chat-left-text"></i></span>
                        <input type="text" class="form-control form-control-dark py-2 text-white border-0 shadow-none fs-6" placeholder="Ej: Pago de nómina extraordinario, Dietas...">
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-dark table-borderless m-0 align-middle">
                    ...
                    <tr class="border-bottom border-secondary border-opacity-10 text-figma-gray fw-bold small" style="font-size: 10px; letter-spacing: 1.5px;">
                        <th class="py-3 px-4" style="width: 25%;"><i class="bi bi-person me-1"></i>EMPLEADO</th>
                        <th class="py-3 px-3" style="width: 20%;"><i class="bi bi-hash me-1"></i>ID DE TRANSACCIÓN</th>
                        <th class="py-3 px-3" style="width: 15%;"><i class="bi bi-calendar-event me-1"></i>FECHA Y HORA</th>
                        <th class="py-3 px-3" style="width: 25%;"><i class="bi bi-chat-left-text me-1"></i>CONCEPTO</th>
                        <th class="py-3 px-4 text-end" style="width: 15%;"><i class="bi bi-currency-dollar me-1"></i>IMPORTE</th>
                    </tr>
                    </thead>
                </table>
            </div>
