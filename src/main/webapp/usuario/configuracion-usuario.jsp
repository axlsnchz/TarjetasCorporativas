                ...
                <div class="card bg-figma-card rounded-4 p-4 h-100 border" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
                    ...
                    <form class="d-flex flex-column gap-3">
                        ...
                        <div>
                            ...
                            <div class="input-group rounded-2 overflow-hidden">
                                <span class="input-group-text bg-figma-input border-0 text-figma-muted px-3"><i class="bi bi-lock"></i></span>
                        ...
                        <div>
                            ...
                            <div class="input-group rounded-2 overflow-hidden">
                                <span class="input-group-text bg-figma-input border-0 text-figma-muted px-3"><i class="bi bi-key"></i></span>
                                <input type="password" class="form-control form-control-dark py-2.5 shadow-none border-end-0" placeholder="••••••••••••">
                        ...
                        <div>
                            ...
                            <div class="input-group rounded-2 overflow-hidden">
                                <span class="input-group-text bg-figma-input border-0 text-figma-muted px-3"><i class="bi bi-key-fill"></i></span>
                                <input type="password" class="form-control form-control-dark py-2.5 shadow-none border-end-0" placeholder="••••••••••••">
                                <button class="btn bg-figma-select text-figma-gray border-0 px-3" type="button">
                                    <i class="bi bi-eye"></i>
                                </button>
                        ...
                        <!-- Botón de Envío -->
                        <div class="mt-3">
                            <button type="submit" class="btn btn-figma-cyan w-100 py-2.5 rounded-pill d-flex align-items-center justify-content-center gap-2">
                                <i class="bi bi-shield-check"></i> Actualizar Credenciales
                            </button>
                        </div>
