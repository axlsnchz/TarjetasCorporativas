                ...
                <div class="card bg-figma-card border-0 rounded-4 p-4 h-100 backdrop-blur" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
                    ...
                    <div class="d-flex flex-column gap-1" id="detailsListContainer">
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-hash text-figma-cyan me-1"></i>Número de cuenta</span>
                            <span id="detailNumFull" class="detail-value font-monospace">CA-#001</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-wallet2 text-figma-cyan me-1"></i>Cuenta</span>
                            <span id="detailNombre" class="detail-value">Viáticos</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-info-circle text-figma-cyan me-1"></i>Estado</span>
                            <span id="detailEstado" class="detail-value text-figma-cyan">Activa</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-person text-figma-cyan me-1"></i>Titular</span>
                        ...
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-speedometer2 text-figma-cyan me-1"></i>Límite asignado</span>
                            <span id="detailLimite" class="detail-value font-monospace">$10,000.00</span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label"><i class="bi bi-currency-dollar text-figma-cyan me-1"></i>Saldo disponible</span>
                        ...
                        <div class="pt-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="detail-label"><i class="bi bi-pie-chart text-figma-cyan me-1"></i>Uso de límite</span>
