    ...
    <div class="row g-4 mb-4 align-items-stretch">
      ...
      <div class="col-xl-4 col-lg-5">
        <div class="card bg-figma-card border-0 rounded-4 p-4 h-100 d-flex flex-column justify-content-center backdrop-blur" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
            <span class="text-uppercase fw-bold mb-1 text-figma-cyan small d-flex align-items-center gap-2" style="letter-spacing: 1.2px;">
              <i class="bi bi-wallet2"></i> Saldo total
            </span>
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="card bg-figma-notice rounded-4 p-4 h-100 d-flex flex-column justify-content-center">
          <h4 class="fw-bold text-white mb-2 fs-5 d-flex align-items-center gap-2"><i class="bi bi-info-circle-fill text-figma-cyan"></i> Bienvenido a FinTech Corp</h4>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-lg-7">
        <div class="card bg-figma-card border-0 rounded-4 p-4 h-100 d-flex flex-column justify-content-between backdrop-blur" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
          <div class="d-flex justify-content-between align-items-start mb-4">
            <div>
              <h4 class="fw-semibold text-white m-0 fs-5 d-flex align-items-center gap-2"><i class="bi bi-bar-chart-line text-figma-cyan"></i> Gasto semanal</h4>
      ...
      <div class="col-lg-5">
        <div class="card bg-figma-card border-0 rounded-4 p-4 h-100 d-flex flex-column backdrop-blur" style="border: 1px solid rgba(255, 255, 255, 0.06) !important;">
          ...
          <h4 class="fw-semibold text-white mb-4 fs-5 d-flex align-items-center gap-2"><i class="bi bi-clock-history text-figma-cyan"></i> Transacciones recientes</h4>
